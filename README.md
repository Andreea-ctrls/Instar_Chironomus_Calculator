...
- Each measurement corresponds to a larval body part size in micrometers or specified units.
...
- The script references size thresholds from Richardi et al. (2018).
